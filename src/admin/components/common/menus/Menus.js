...
import { keys, includes, map } from 'lodash'
...
export const MainMenu = () => {
    ...
    if ( logged_in_user.is_superuser ) {
        ...
        allowed_menu_keys = ["dashboard", "orders", "reports", "inventory", "donors", "beneficiaries"]
    }
    const menu_items = map(allowed_menu_keys, (menu_key) => ALL_MENU_ITEMS[menu_key])
