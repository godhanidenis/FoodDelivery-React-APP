...
import { adminParcelPickerHistoryList } from './actions/admin_parcel_picker_history'
import AdminStateHistoryList from '../layout/AdminStateHistoryList'
import Timestamp from 'components/Timestamp'
import { useDispatch } from 'react-redux'

export const AdminParcelPickerHistory = ({parcel_id}) => {

    const dispatch = useDispatch()
    const item_list = adminParcelPickerHistoryList
    ...
    const columns = [
        ...
        { field: 'new_picker_display_name', title: 'Picker'},
    ...
    return (
        ...
        <AdminStateHistoryList item_list={item_list}
                               columns={columns}
                               active_key={'Parcel picker history'} />
    )
}
